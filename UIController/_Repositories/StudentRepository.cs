...
namespace UIController._Repositories
{
    public class StudentRepository : BaseRepositories, IRepository
    {
        ...
        public void Add(TeacherModel studentModel)
        {
        ...
        public void Edit(TeacherModel studentModel)
        {
            using (var connection = new SQLiteConnection(connectionString))
            using (var command = new SQLiteCommand())
            {
        ...
        {
            var studentList = new List<TeacherModel>();
            using (var connection=new SQLiteConnection(connectionString))
                using (var command = new SQLiteCommand())
            {
                connection.Open();
                ...
                using(var reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        var studentModel = new TeacherModel();
        ...
        public IEnumerable<TeacherModel> GetByValue(string value)
        {
